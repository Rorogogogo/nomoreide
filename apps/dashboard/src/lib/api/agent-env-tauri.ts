...
export const tauriAgentEnvApi: AgentEnvApi = {
  ...
  getAgentEnvSettings: notAvailable,
  saveAgentEnvSettings: notAvailable,
  setAgentEnvModel: notAvailable,
  listAgentEnvProfiles: async () => [],
  getAgentEnvProfileRegistryDiff: notAvailable,
  ...
  listAgentEnvRegistryProfiles: notAvailable,
