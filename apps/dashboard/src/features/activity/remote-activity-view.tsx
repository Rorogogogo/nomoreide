...
import { metricPressure, metricPressureTextClass } from "./metric-pressure";

/**
 * Activity for one SSH host, read over SSH and rendered read-only.
 *
 * Split out of `activity-page.tsx`, which keeps the host picker and decides
 * which of the three views — local, Docker, or this one — is showing.
 *
 * Remote controls are deliberately absent: the page can *read* a remote host's
 * processes, and stopping one is not something a read-safe surface offers.
 */
