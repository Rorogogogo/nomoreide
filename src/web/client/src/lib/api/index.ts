 ...
 *
 * To add an endpoint: extend the relevant domain module (`agent`, `git`,
 * `services`) or add a new one and re-export it here. Low-level transport
 * (`requestJson`, form helpers) stays in `client.ts`.
 */
