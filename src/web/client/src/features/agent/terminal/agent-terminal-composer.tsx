...
export function AgentTerminalComposer({ capabilities, onNavigate, onShellMode, shellMode = false }: { capabilities?: AgentCapabilities; onNavigate?: (page: AgentDockPage) => void; onShellMode?: (shell: boolean) => void; shellMode?: boolean }) {
  ...
  // Bottom-aligned, like a chat log that happens to be empty — the input stays
  // where it will be once messages push it down, instead of jumping there on
  // the first send.
  return <div className="flex h-full items-end justify-center overflow-auto p-6">
    <div className="w-full max-w-3xl">
      {/* The greeting is what makes an empty chat read as an invitation rather
      ...
      <div className="overflow-hidden rounded-xl border border-border bg-card shadow-sm">
        ...
        <div className="flex h-10 items-center gap-1 border-t border-border px-2">
          ...
          {/* Model sits beside the send button, where a chat app puts it — this
