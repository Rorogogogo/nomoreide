    ...
    <div className={fill ? "flex h-full min-h-0 flex-col" : "flex flex-col gap-2"}>
      <div className="flex shrink-0 flex-wrap items-center gap-2 border-b border-border px-3 py-1.5">
        ...
        {canQuery ? (
          ...
          <ToggleButton
            active={hideStdout}
            activeClassName="bg-amber-500/10 text-amber-700 dark:bg-amber-500/15 dark:text-amber-300"
        ...
        <ToggleButton
          active={streaming}
          activeClassName="bg-emerald-500/10 text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-300"
